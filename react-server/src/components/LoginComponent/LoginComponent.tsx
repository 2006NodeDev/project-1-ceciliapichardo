...
import { makeStyles, createStyles, Theme, InputAdornment, Typography, Link } from '@material-ui/core';
        ...
        <div> <br /><br /><br /><br /><br /><br /><br />
            <form autoComplete="off" onSubmit={loginSubmit}>
                ...
                <Typography variant='body2'>
                    <Link onClick={preventDefault} color="inherit" className={classes.link}>
